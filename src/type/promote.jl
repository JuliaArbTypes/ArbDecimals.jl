...
for T in (:Int128, :Int64, :Int32, :Int16, :Float64, :Float32, :Float16,
          ...
          :String)
  @eval promote_rule{D,P}(::Type{ArbDec{D,P}}, ::Type{$T}) = ArbDec{D,P}
end

float{D,P}(x::ArbDec{D,P}) = x

promote_rule{D,P}(::Type{ArbDec{D,P}}, ::Type{BigFloat}) = ArbDec{D,P}
promote_rule{D,P}(::Type{ArbDec{D,P}}, ::Type{BigInt}) = ArbDec{D,P}
